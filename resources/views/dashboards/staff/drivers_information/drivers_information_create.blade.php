...
<div class="w3-container w3-black">
  <h1>DRIVERS INFORMATION ADD RECORDS</h1>
</div>
...
<div class="w3-container">
    <div class="container">
        <div class="row" style="margin:20px;">
            ...
            @endif
  <div class="card-header">Create New Driver's Information</div>
  <div class="card-body">
  ...
  <div class="panel-body">
                    <form action="{{ route('drivers.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="homephone" required>
                        </div>
                        <br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="drivers_license" required>
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="drivers_state">Drivers State </label>
                            <input class="form-control" type="text" name="drivers_state" required>
                        </div>
                        <br>
                        <div class="form-group">
