                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="Actions">
                                    <a href="{{ route('traffic_verify', $item->id) }}" title="Verify"><button class="btn btn-info"><i class="fa fa-check" aria-hidden="true"></i>Verify Payment</button></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<div class="sidebar">
    ...
    <ul>
        ...
        <li>
            <a href="{{ route('traffic_cashier')}}" class="active">
