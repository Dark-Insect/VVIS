...
.card-body .search-container button {
  float: right;
  padding: 6px 10px;
  margin-top: 8px;
  margin-right: 16px;
...
.card-body .search-container button:hover {
  background: #ccc;
}
...
@media screen and (max-width: 600px) {
  ...
  .card-body a, .card-body input[type=text], .card-body .search-container button {
    float: none;
    display: block;
    text-align: left;
    width: 100%;
    ...
    <div class="down-container">
        <div class="row">
            <section class="bg-light p-5">
                <h3 class="pb-2">Motor Vehicle Impounding Receipt</h3>
                <div class="card-body">
                    <a href="{{ route('moto.create') }}" class="btn btn-primary" title="Add">
                        Add New
                    </a>
                    <a href="{{ route('pdf.moto')}}" class="btn btn-warning btn-sm" title="Export">
                        Export PDF
                    </a>
                          ...
                          <tbody>
                            ...
                            <tr>
                                <td data-title="ID">{{ $loop->iteration }}</td>
                                    ...
                                    <td data-title="Telephone No.">{{ $item->telephonenumber }}</td>
                                    <td data-title="Driver">{{ $item->completenameofthedriver}}</td>
                                <td data-title="Actions">
                                    <a href="{{ route('moto.view', $item->id) }}" title="View"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                    <a href="{{ route('payment_view_moto', $item->id) }}" title="Voucher"><button class="btn btn-dark btn-sm"><i class="fa fa-tag" aria-hidden="true"></i> Voucher</button></a>
                                    <a href="{{ route('moto.update', $item->id) }}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
