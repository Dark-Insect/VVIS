...
<div class="w3-sidebar w3-black w3-bar-block" style="width:15%">
  ...
  <a href="{{ route('vehicle_information') }}"  class="w3-bar-item w3-button w3-grey" class="w3-bar-item w3-button">Vehicle Information</a>
        ...
        <div class="topnav">
            ...
            <div class="search-container">
              <form action="">
                ...
                <a href="{{ route('vehicle_information')}}" type="button"><i class="reset">Reset Search</i></a>
              </form>
            </div>
          </div>
    </div>
                ...
                <div class="card">
                    <div class="class-header">
                        <h2></h2>
                                    ...
                                    <div class="card-body">
    <a href="{{ route('vehicle.create') }}" class="btn btn-success btn-sm" title="Add">
        Add New
    </a>
    <a href="{{ route('pdf.vehicle') }}" class="btn btn-warning btn-sm" title="Export">
        Export PDF
    </a>
                                ...
                                <thead>
                                 ...
                                 @foreach($vehicle_information as $item)
                                    <tr>
                                       ...
                                       <td>
                                         <a href="{{ route('vehicle.view', $item->id)}}" title="View"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ route('vehicle.update', $item->id) }}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form method="POST" action="{{ route('vehicle.delete', $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
