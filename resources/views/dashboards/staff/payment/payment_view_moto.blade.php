                    ...
                    <div class="side-img1"><img src="https://i.ibb.co/CJZLTr5/Dumaguete-Logo.png"
                       ...
                       <div class="side-img2"><img src="https://i.ibb.co/TbbbJyF/TRAFFIC-LOGO-PART-2.png"
                        ...
                        <div class="ticket-content">
                          ...
                          <p class="ticket-description">{{$moto_vehicle->ownerofthevehicle }}</p>
                        </div>
                        <div class="ticket-content">
                            <label class="ticket-label">Complete Address</label>
                            <p class="ticket-description">{{$moto_vehicle->completeaddress}}</p>
                          </div>
                          <div class="ticket-content">
                            <label class="ticket-label">Status</label>
                            <p class="ticket-description">{{$moto_vehicle->status}}</p>
                          </div>
                          <div class="ticket-content">
