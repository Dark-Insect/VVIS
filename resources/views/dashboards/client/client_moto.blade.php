    ...
    <div class="down-container">
                                ...
                                <tr>
                                    <td data-title="ID">{{ $loop->iteration }}</td>
                                            ...
                                            <td data-title="Actions">
                                                ...
                                                <a href="{{ route('moto_view', $item->id)}}" title="View"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
     ...
     <div class="sidebar">
         ...
         <ul>
             ...
             <li>
                 <a href="{{ route('client_moto')}}" class="active">
