    ...
    <div class="down-container">
        <div class="row">
            <section class="bg-light p-5">
                <h3 class="pb-2">Traffic Violation Citation Ticket (Create)  </h3>
                <div class="card-body">
                    <div class="panel-body">
                        <form action="{{ route('traffic.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select @error('licensetype') is-invalid @enderror" type="string" name="licensetype" id="licensetype" required>
