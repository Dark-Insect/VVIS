    ...
    <div class="down-container">
        <div class="row">
            <section class="bg-light p-5">
                <h3 class="pb-2">TRAFFIC VIOLATION CITATION TICKET</h3>
                <div class="card-body">
                    <div class="ticket">
                            ...
                            <table class="table bg-white" id="example">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-title="Owner">{{ $item->name }}</td>
                                    <td data-title="Address">{{ $item->address }}</td>
                                    <td data-title="Telephone No.">{{ $item->type}}</td>
                                    <td data-title="Driver">{{ $item->drivers_license_no}}</td>
                                    <td data-title="License No.">{{ $item->registration_no}}</td>
                                    <td data-title="Actions">
                                        <a href="{{ route('traffic_view', $item->id)}}" title="View"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
     ...
     <div class="sidebar">
         ...
         <ul>
             ...
             <li>
                 <a href="{{ route('client_traffic')}}" class=active>
