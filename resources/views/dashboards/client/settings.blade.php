    ...
    <div class="down-container">
        <div class="row">
            <section class="bg-light p-5">
                <h3 class="pb-2">EDIT PROFILE SETTINGS</h3>
                <div class="card-body">
                    <div class="ticket">
                            ...
                            <div class="row">
                                <div class="col-md-3 border-right">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        <img class="rounded-circle mt-5" width="150px" src="https://e7.pngegg.com/pngimages/760/305/png-clipart-computer-icons-symbol-driving-symbol-miscellaneous-driving.png"><span class="font-weight-bold">{{ Auth::user()->name }}</span><span class="text-black-50">{{ Auth::user()->email }}</span><span> </span></div>
                                </div>
                                <div class="col-md-5 border-right">
                                    <div class="p-3 py-5">
                                        ...
                                        <form action="{{ route('client.edit', $users->id)}}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="string" name="username" value="{{$users->username}}" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="string" name="contact" value="{{$users->contact}}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="address">Address</label>
                                                <input class="form-control" type="string" name="address" value="{{$users->address}}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="licenseno">License No.</label>
                                                <input class="form-control" type="number" name="licenseno" value="{{$users->licenseno}}" required>
                                            </div>

                                            <div class="form-group position-relative has-icon-left mb-4">
                                                <label for="email">License Type</label>
                                                <fieldset class="form-group">
                                                    <select class="form-select @error('licensetype') is-invalid @enderror" name="licensetype" required>
