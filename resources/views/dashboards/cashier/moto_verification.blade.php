    ...
    <div class="down-container">
        <div class="row">
            <section class="bg-light p-5">
                <h3 class="pb-2">Motor Vehicle Impounding Receipt (Verify Payment)</h3>
                <div class="card-body">
                    <div class="panel-body">

                        <form action="{{ route('moto_verify', $moto_vehicle->id)}}" method="POST">
                ...
                <div class="ticket">
                    <div class="ticket-header">
                        <p>REPUBLIC OF THE PHILIPPINES
                            ...
                            <hr>
                      <h2>MOTOR VEHICLE IMPOUNDING RECEIPT</h2>
                    </div>
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <fieldset class="form-group">
                        <select class="form-select @error('status') is-invalid @enderror" name="status" id="status">
                            <option selected disabled>Select Status Verification</option>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" name="amount" value="{{$moto_vehicle->amount}}" required>
                </div>
                <br>
            <div class="form-group">
...
<div class="sidebar">
    ...
    <ul>
        ...
        <li>
            <a href="{{ route('moto_cashier') }}" class="active">
