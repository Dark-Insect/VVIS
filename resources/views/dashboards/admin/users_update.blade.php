    ...
    <div class="down-container">
        <div class="row">
            <section class="bg-light p-5">
                <h3 class="pb-2">User Accounts Update</h3>
                <div class="card-body">
                    <form action="{{ route('users.update', $users->id) }}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <fieldset class="form-group">
                                <select class="form-select @error('user_role') is-invalid @enderror" name="user_role" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="string" name="password" value="{{$users->password}}" required>
                        </div>
