    ...
    <div class="down-container">
        <div class="row">
            <section class="bg-light p-5">
                <h3 class="pb-2">Traffic Violation Citation Ticket (Verify Payment)</h3>
                <div class="card-body">
                    <div class="panel-body">

                        <form action="{{ route('traffic_verify', $traffic_violation->id)}}" method="POST">
      ...
      <div class="ticket-content">
        ...
        <span>{{$traffic_violation->trafficofficer}}</span>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" name="amount" value="{{$traffic_violation->amount}}" required>
                </div>
                <br>
            <div class="form-group">
